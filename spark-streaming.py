...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/Users/vijapuraakib/Desktop/realtime-voting-data-engineering/postgresql-42.7.1.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/vijapuraakib/Desktop/realtime-voting-data-engineering/checkpoints/checkpoints1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/vijapuraakib/Desktop/realtime-voting-data-engineering/checkpoints/checkpoints2") \
        .outputMode("update") \
        .start()
